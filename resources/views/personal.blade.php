      ...
      <div class="action-cards">
        ...
        <div class="action-card">
          ...
          <form action="{{ route('personal-agregar') }}" method="POST">
            ...
            <div class="form-group">
              <label for="cargo_id"><i class="fas fa-briefcase"></i> Cargo:</label>
            ...
            <div class="form-group">
              <label for="tiempo_inicio"><i class="fas fa-calendar-alt"></i> Fecha de Inicio:</label>
              <input type="date" name="tiempo_inicio" id="tiempo_inicio" required>
            </div>

            <div class="form-group">
    <label for="sucursal_id"><i class="fas fa-building"></i> Sucursal:</label>
